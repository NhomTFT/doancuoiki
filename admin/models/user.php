<?php
	...
	class User extends Db
	{
		...
		function Register($ho_ten,$sdt,$email,$username,$password,$role)
		{
			...
			if($item == null)
			{
				$sql = self::$connection->prepare("INSERT INTO users(ho_ten,sdt,email,user_name,password,role) VALUES( '$ho_ten','$sdt','$email', '$username','$password','$role')");
					$sql->execute();
