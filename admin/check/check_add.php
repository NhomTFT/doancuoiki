<?php
	...
	if(isset($_POST['action']) && $_POST['action'] == 'register') {
		$user = new User();
		if( isset($_POST['hoten']) && isset($_POST['sdt']) && isset($_POST['email']) && isset($_POST['name']) && isset($_POST['password']) && $_POST['role'])
		{
			$ho_ten = $_POST['hoten'];
			$sdt = $_POST['sdt'];
			$email = $_POST['email'];
			...
			$role = $_POST['role'];
			$user->Register($ho_ten,$sdt,$email,$username,$password,$role);
		}
	}